...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/css/statistics_categories_CA.css">
...
<div class="card w-100 h-100 shadow">
	<div class="card-header card-header-quicklook" ><?php echo $lang['Compare_national']?></div>
	<div class="card-body">
		<canvas id="mainGraph" style="width:600px;height:250px;"></canvas>
	</div>
</div>
...
<script src="<?php echo base_url()?>/scripts/statistics_categories.js"></script>
